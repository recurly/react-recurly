  ...
  return class extends React.Component {
    ...
    constructor (props, context) {
      if (!context || !context.getRegisteredFields) {
        throw new Error(
          `It looks like you are trying to inject Recurly context outside of a Fields context.
    ...
    componentDidMount () {
      if (this.context.tag === 'async') {
        this.context.addRecurlyLoadListener(recurly => {
          this.setState({ recurly: this.recurlyProps(recurly) });
        });
      }
    }
